...
CTriangleMeshShape::CTriangleMeshShape() : CollisionMesh(0) {
}

btTriangleMesh *CTriangleMeshShape::createTriangleMesh(IMesh* const mesh) {
...
CTriangleMeshShape::~CTriangleMeshShape() {
