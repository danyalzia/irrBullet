...
*/
class CTriangleMeshShape : public CCollisionShape, ITriangleMeshShape
{
    public:
		CTriangleMeshShape();
    ...
    protected:
        ...
        void createShape(irr::scene::IMesh* const collMesh) override;

        /// @return The btTriangleMesh created by extracting the geometry from an Irrlicht IMesh.
        btTriangleMesh *createTriangleMesh(irr::scene::IMesh* const mesh) override;
