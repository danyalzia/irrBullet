...
#include "irrBulletCCollisionShape.h"

using namespace irr;
using namespace core;
using namespace scene;

void CCollisionShape::setLocalScaling(const vector3df &scaling, const EScalingPair esp) {
...
void CCollisionShape::calculateLocalInertia(irr::f32 Mass, const vector3df &inertia) {
...
void CCollisionShape::createShape() {
	
}


const vector3df CCollisionShape::getLocalScaling() const {
